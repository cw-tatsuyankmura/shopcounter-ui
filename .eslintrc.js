...
module.exports = {
  ...
  rules: {
    ...
    'react/jsx-filename-extension': [ERROR, { extensions: ['.js'] }], // reactの拡張子はjsを使う
    'react/jsx-handler-names': ERROR, // イベントハンドラに無名関数を使わない
    'react/prefer-es6-class': [ERROR, 'always'], // ES6のクラス記法を使う
    // "react/display-name": [ERROR, { "acceptTranspilerName": true }],
    ...
    // 'react/jsx-max-props-per-line': [ERROR, { maximum: 2 }], // 一行に掛ける最大のprops数
    ...
    'react/no-multi-comp': ERROR, // 1ファイルに複数のコンポーネントを定義しない
    ...
    'import/newline-after-import': ERROR, // importの後に空行を入れる
    'import/imports-first': ERROR, // importはファイルの先頭に書く
    // 'import/prefer-default-export': ERROR, // デフォルトエクスポートを優先して使用する
    'import/no-extraneous-dependencies': ERROR, // package.jsonにないファイルをインポートしない
    'import/no-mutable-exports': ERROR, // var, letのエクスポート禁止
    'import/no-commonjs': ERROR, // requireではなくimportを使う
    'import/order': ERROR, // node_modulesを先にimportする
  },
  settings: {
